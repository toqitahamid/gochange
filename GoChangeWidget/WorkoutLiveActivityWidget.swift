...
struct WorkoutActivityWidget: Widget {
    var body: some WidgetConfiguration {
        ActivityConfiguration(for: WorkoutActivityAttributes.self) { context in
            ...
            let workoutColor = Color(hexString: context.attributes.workoutColor) ?? LiveActivityColors.workoutGradientStart
...
struct UnifiedLockScreenView: View {
    ...
    private var workoutColor: Color {
        Color(hexString: context.attributes.workoutColor) ?? LiveActivityColors.workoutGradientStart
    }
